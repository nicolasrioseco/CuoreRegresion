...
public class AtributoInicial {
	...
	public static String altaTipoSeguro;

	public void atributosIniciales() {
		...
		if(serchCabeceraTipo == 0) {
			...
			System.out.println("Ya existe el Atributo Cabecera: \"Tipo de seguro\"");
			System.out.println("\n*************************************************************************\n");
		}
		...
		if(serchCabeceraClase == 0) {
			...
			System.out.println("Ya existe el Atributo Cabecera: \"Clase seguro\"");
			System.out.println("\n*************************************************************************\n");
		}
	}
	...
	public String bodyAltaAtributo(String atributo) {
		...
		AtributoInicial.altaTipoSeguro = 
				("{\"name\": \"" + atributo + "\"," + 
