...
public class ParametrosProductos {
	...
	public void AltaProducto(int row, String bodyBien) throws Exception {
		...
		ParametrosProductos.seguroID = ((bodyProducto.split("hasMarkUpPercentageEnabled\":false,\"id\":"))[1]).split(",\"markUpCurrency")[0];
		ParametrosProductos.productoVRKPOItemID = ((bodyProducto.split("},\"id\":"))[1]).split(",\"requestValidationObservation")[0];
	}
